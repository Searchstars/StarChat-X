    ...
    public sealed partial class MainWindow : Window
    {
        ...
        private async void Button_Click(object sender, RoutedEventArgs e)//Login Click
        {
            ...
            else if(RunningDataSave.user_ip_addr == "noinit")
            {
                ...
                {
                    Title = "年轻人666",
                    Content = "我草这手速，吓我一跳释放忍术🥷",
                    PrimaryButtonText = "点击释放",
                    CloseButtonText = "我是傻逼",
                    DefaultButton = ContentDialogButton.Close
                };
                cd.XamlRoot = this.Content.XamlRoot;
                var result = await cd.ShowAsync();
                ...
                {
                    System.Diagnostics.Process.Start("start \"https://www.bilibili.com/video/BV1Z84y147JF/?share_source=鼠睿专属分享链接&t=184\"");
                }
            }
            else
            {
